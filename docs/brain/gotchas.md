...
| [backend](./gotchas/backend.md) (`docs/brain/gotchas/backend.md`) | `server/` routes, data access, the Gemini AI proxy, logging transport | 10 (over ~150-line split threshold — propose a further split next Merge Gate) |
| [angular](./gotchas/angular.md) (`docs/brain/gotchas/angular.md`) | `src/app/` components, signals-based state, routing, change-detection behavior | 11 |
