...
- [x] Update TRIAGE.md â€” Cluster 10 âœ“ resolved
- [x] Fallout: `row-actions-menu` popover clipped by list `.table-area` — body portal + viewport clamp + tighter chrome (keep ≥44×44)
