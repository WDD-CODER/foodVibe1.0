...
> ALL MILESTONES DONE (2026-09-16). Milestone 1 merged to `main` (PR #177), Human-validated 2026-08-13. Milestone 3 (dashboard count endpoint) and Milestone 4 (collapse double-fetch) both shipped and Human-validated 2026-08-31. Milestone 2 carved out to plan 310.
...
- [x] Milestone 2 — carved out to Plan 310 (below) — see `plans/310-faceted-search-pagination-inventory-recipe-book.plan.md` — resolved (relocated) as far as plan 301 is concerned
