...
```markdown
## Backend Impact
<!-- [PROJECT_SPECIFIC] Reference your backend standards file and entity registry here -->
- Collections affected: [list entity keys from .claude/standards-backend.md §1]
