...
- **Backend Impact check** — if the plan includes a `## Backend Impact` section with new collections:
  <!-- [PROJECT_SPECIFIC] Backend Impact Check -->
  <!-- Add your project's persistence layer impact checks here -->
  <!-- Example: verify the new entity key is added to your backup/restore service before marking the task done -->
