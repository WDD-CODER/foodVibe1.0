...
description: Manual-only maintenance — invoke explicitly via /reflect or /reflect-list.
---

# Reflect Agent — Manual-Only Maintenance

> **MANUAL-ONLY. Cron schedule disabled by default.**
> **Trigger:** Manual via `/reflect` or `/reflect-list`.
...
**Never push to main. The branch stays open for the user to review and merge.**
