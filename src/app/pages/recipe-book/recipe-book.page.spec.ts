...
import { of } from 'rxjs';
import { LucideAngularModule, Menu, Plus, X, Search, ArrowUpDown, ArrowUp, ArrowDown, ShieldAlert, Pencil, Trash2, BookOpen, Tag, ChevronRight, ChevronLeft, ChevronDown, CircleX } from 'lucide-angular';
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [
        ...
        LucideAngularModule.pick({ Menu, Plus, X, Search, ArrowUpDown, ArrowUp, ArrowDown, ShieldAlert, Pencil, Trash2, BookOpen, Tag, ChevronRight, ChevronLeft, ChevronDown, CircleX })
      ],
      providers: [
        provideHttpClient(),
