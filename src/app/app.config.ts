...
import { ArrowDown, ArrowLeft, ArrowRight, ArrowUp, ArrowUpDown, Archive, CalendarClock, ChevronDown, ChevronLeft, ChevronRight, Circle, CircleCheck, CircleX, CookingPot, Download, Edit, FilePlus, Flame, FlaskConical, GripVertical, History, Image, LucideAngularModule, MapPin, Menu, Minus, Package, Pencil, Plus, PlusCircle, RotateCcw, Save, Scale, Search, ShieldAlert, Table2, Timer, Trash2, Truck, TrendingUp, Upload, Utensils, Tags, BookOpen, Copy, PanelRightClose, Filter, PanelLeftClose, Info, Printer, UtensilsCrossed, ChevronUp, Library, CircleUserRound } from 'lucide-angular';
