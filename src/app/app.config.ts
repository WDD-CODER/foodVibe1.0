...
import { ArrowDown, ArrowLeft, ArrowRight, ArrowUp, ArrowUpDown, Archive, CalendarClock, ChevronDown, ChevronLeft, ChevronRight, Circle, CircleCheck, CircleX, ClipboardList, CookingPot, Download, Edit, FileDown, FilePlus, Flame, FlaskConical, GripVertical, History, Image, LucideAngularModule, MapPin, Menu, Minus, Package, Pencil, Plus, PlusCircle, RotateCcw, Save, Scale, Search, Settings, ShieldAlert, Star, Table2, Timer, Trash2, Truck, TrendingUp, Upload, Utensils, Tags, BookOpen, Copy, PanelRightClose, Filter, PanelLeftClose, Info, Printer, UtensilsCrossed, ChevronUp, Library, CircleUserRound, Eye, CookingPotIcon } from 'lucide-angular';
