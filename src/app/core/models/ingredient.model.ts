/**
 * Ingredient Ledger model — Atomic layer with UID identity and triple-unit conversion.
 * Why: UIDs and three-unit mapping decouple procurement, storage, and recipe usage so
