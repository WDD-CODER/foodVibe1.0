...
describe('ItemDataService', () => {
  ...
  it('should be created and load initial data', async () => {
    ...
    expect(service.allItems_()).toEqual(mockItems);
  ...
  it('should add an item and update the signal', async () => {
    ...
    expect(service.allItems_()).toContain(savedItem);
  });
  ...
  it('should update an existing item in the signal', async () => {
    ...
    const result = service.allItems_().find(i => i._id === '1');
  ...
  it('should delete an item and remove it from the signal', async () => {
    ...
    expect(service.allItems_().length).toBe(1);
    expect(service.allItems_().find(i => i._id === '1')).toBeUndefined();
  });
});