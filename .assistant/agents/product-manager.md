...
Apply all project standards from `.assistant/copilot-instructions.md` — especially Section 1.1 (Q&A format), Section 2 (Gatekeeper Protocol), Section 7 (translation).
