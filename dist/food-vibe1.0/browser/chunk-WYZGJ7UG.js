...
var HttpStorageAdapter = class _HttpStorageAdapter {
  ...
  query(entityType, _delay = 100) {
    return __async(this, null, function* () {
      return firstValueFrom(this.http.get(`${this.base}/api/v1/data/${entityType}`, { headers: this.headers(), withCredentials: true }));
    });
  }
  /** Returns one entity by id. Throws if not found (404 → HttpErrorResponse). */
  get(entityType, entityId) {
    return __async(this, null, function* () {
      return firstValueFrom(this.http.get(`${this.base}/api/v1/data/${entityType}/${entityId}`, { headers: this.headers(), withCredentials: true }));
    });
  }
  /**
  ...
  post(entityType, newEntity) {
    return __async(this, null, function* () {
      ...
      return firstValueFrom(this.http.post(`${this.base}/api/v1/data/${entityType}`, entityWithId, { headers: this.headers(), withCredentials: true }));
    });
  }
  /** Updates one entity. Uses updatedEntity._id as the path parameter. */
  put(entityType, updatedEntity) {
    return __async(this, null, function* () {
      return firstValueFrom(this.http.put(`${this.base}/api/v1/data/${entityType}/${updatedEntity._id}`, updatedEntity, { headers: this.headers(), withCredentials: true }));
    });
  }
  /** Removes one entity by id. */
  remove(entityType, entityId) {
    return __async(this, null, function* () {
      yield firstValueFrom(this.http.delete(`${this.base}/api/v1/data/${entityType}/${entityId}`, { headers: this.headers(), withCredentials: true }));
    });
  }
  /**
  ...
  appendExisting(entityType, entity) {
    return __async(this, null, function* () {
      yield firstValueFrom(this.http.post(`${this.base}/api/v1/data/${entityType}`, entity, { headers: this.headers(), withCredentials: true }));
    });
  }
  /**
...
//# sourceMappingURL=chunk-WYZGJ7UG.js.map
