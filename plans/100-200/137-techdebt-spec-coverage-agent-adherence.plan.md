...
- **.claude/copilot-instructions.md**: Section 0 "Commit/push → read commit-to-github" and separately "End of session, before PR → read techdebt." Commit is not explicitly tied to "run Phase 0 first."
...
3. **.claude/copilot-instructions.md**: In commit trigger, added "Before building the commit plan (Phase 1), complete Phase 0 (tech-debt pass + Spec coverage)."
