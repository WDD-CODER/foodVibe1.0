...
| 2 | Inventory | `src/app/pages/inventory/` | `Inventory.dc.html` | in-progress | `02-inventory.port-spec.md` |
| 3 | Recipe Book | `src/app/pages/recipe-book/` | `RecipeBook.dc.html` | in-progress | `03-recipe-book.port-spec.md` |
