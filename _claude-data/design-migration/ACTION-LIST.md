...
- **G. Small** — 0 / 3
- **H. New data concepts** — 7 / 8. 6 already existed, Venues built this session. 1 genuine gap remains: Recipe Builder secondary yields. Profit-per-portion is half-done (field exists, calculation doesn't)

**Total: 14 / 55** (8 of those needed zero code, only verification against live source — see the note under §H)
